    ...
    <>
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="bg-white p-10 rounded-3xl shadow-xl max-w-lg w-full text-center border border-slate-200">
          ...
          <p className="text-slate-500 mb-6">Acesso restrito para tokenização de ativos reais.</p>

          <div className="mb-6 p-4 bg-slate-50 rounded-xl border border-slate-100">
            <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-1">Seu Saldo</p>
            <p className="text-3xl font-extrabold text-slate-800 flex items-center justify-center gap-2">
          ...
          {!isConnected ? (
            <button onClick={connectWallet} className="w-full py-3 bg-slate-900 text-white rounded-lg font-bold hover:bg-slate-800 transition-colors">
              Conectar Carteira
            </button>
          ) : (
            <div className="space-y-3">
              <button
                ...
                className="w-full py-4 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 flex justify-center items-center gap-2 shadow-lg shadow-blue-200 transition-all hover:scale-[1.02]"
              >
                {isCreditLoading ? <Loader2 className="animate-spin" /> : <Zap className="fill-white" />}
                {credits > 0 ? "Desbloquear Acesso (1 Crédito)" : "Comprar Créditos"}
              </button>
